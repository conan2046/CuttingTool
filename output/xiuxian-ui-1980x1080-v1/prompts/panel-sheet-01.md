...
1. PlayerProfileFrame | state=Default | wide player profile and portrait frame with open clean content area
2. CurrencyCounterFrame | state=Default | slender horizontal currency counter frame, reusable
3. MinimapFrame | state=Default | tall compact minimap frame with empty center
4. QuestPanel | state=Default | tall quest panel frame with clean content body
