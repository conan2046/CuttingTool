...
1. ChatTab | state=Normal | compact chat channel tab, blank center
2. ChatTab | state=Hover | same exact tab, brighter hover rim
3. ChatTab | state=Pressed | same exact tab, selected pressed appearance
4. ChatTab | state=Disabled | same exact tab, desaturated disabled
5. VoiceChat | state=Normal | small circular microphone-symbol button
6. VoiceChat | state=Hover | same exact button, brighter hover rim
7. VoiceChat | state=Pressed | same exact button, visibly pressed
8. VoiceChat | state=Disabled | same exact button, desaturated disabled
9. SendChat | state=Normal | medium action button, blank center
10. SendChat | state=Hover | same exact button, brighter hover rim
11. SendChat | state=Pressed | same exact button, visibly pressed
12. SendChat | state=Disabled | same exact button, desaturated disabled
