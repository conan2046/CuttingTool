...
1. QuestRowFrame | state=Default | wide shallow reusable quest list row frame
2. ChatPanel | state=Default | wide chat panel frame with clean message body and input zone
3. BottomNavSlotFrame | state=Default | square bottom navigation slot frame with open center
4. VerticalOrnamentBanner | state=Default | slender vertical decorative xianxia filigree banner
