...
1. AddCurrency | state=Normal | small circular plus-symbol button
2. AddCurrency | state=Hover | same exact button, brighter hover rim
3. AddCurrency | state=Pressed | same exact button, visibly pressed
4. AddCurrency | state=Disabled | same exact button, desaturated disabled
5. ExitGame | state=Normal | wide scroll-edged action button, blank center
6. ExitGame | state=Hover | same exact button, brighter hover rim
7. ExitGame | state=Pressed | same exact button, visibly pressed
8. ExitGame | state=Disabled | same exact button, desaturated disabled
9. WorldMap | state=Normal | wide ornamental action button, blank center
10. WorldMap | state=Hover | same exact button, brighter hover rim
11. WorldMap | state=Pressed | same exact button, visibly pressed
12. WorldMap | state=Disabled | same exact button, desaturated disabled
